...
namespace BlogPostApp.Controllers
{
    public class CommentsController : Controller
    {
        ...
        {
            var blogPostDbContext = _context.Comments.Include(c => c.BlogPost);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Content,DatePosted,BlogPostId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Content,DatePosted,BlogPostId")] Comment comment)
        {
            if (id != comment.Id)
            {
                return NotFound();
